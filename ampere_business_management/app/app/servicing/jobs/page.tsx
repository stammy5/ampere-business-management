...
export default function ServiceJobsPage() {
  ...
  const filteredJobs = jobs.filter(job => {
    const searchMatch = 
      ...
      (job.assignedVendor && job.assignedVendor.name.toLowerCase().includes(searchTerm.toLowerCase()))
                      ...
                      <TableCell className="text-right">
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end">
                            ...
                            <DropdownMenuItem onClick={() => router.push(`/servicing/jobs/${job.id}/jobsheet`)}>
                              <FileText className="mr-2 h-4 w-4" />
                              Job Sheet
                            </DropdownMenuItem>
                            
                            {job.assignedToType === 'Vendor' && (
                              <DropdownMenuItem onClick={() => router.push(`/servicing/jobs/${job.id}/vendor-reports`)}>
                                <Upload className="mr-2 h-4 w-4" />
                                Vendor Reports
                              </DropdownMenuItem>
                            )}
                            
                            <DropdownMenuItem onClick={() => router.push(`/servicing/jobs/${job.id}/invoices`)}>
