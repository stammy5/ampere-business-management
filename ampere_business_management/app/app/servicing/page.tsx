        ...
        <Tabs defaultValue="dashboard" className="w-full">
          <TabsList className="grid w-full grid-cols-5">
            ...
            <TabsTrigger value="calendar">
              <Link href="/servicing/calendar" className="flex items-center">
                <Calendar className="mr-2 h-4 w-4" />
                Calendar
              </Link>
            </TabsTrigger>
            <TabsTrigger value="contracts">
              <Link href="/servicing/contracts" className="flex items-center">
                <FileText className="mr-2 h-4 w-4" />
                Contracts
              </Link>
            </TabsTrigger>
            <TabsTrigger value="jobs">
              <Link href="/servicing/jobs" className="flex items-center">
                <Wrench className="mr-2 h-4 w-4" />
                Jobs
              </Link>
            </TabsTrigger>
            <TabsTrigger value="reports">
              <Link href="/servicing/reports" className="flex items-center">
