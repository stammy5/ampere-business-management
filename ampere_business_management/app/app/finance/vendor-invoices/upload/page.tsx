...
export default function UploadVendorInvoicePage() {
  ...
  const canSave = () => {
    return invoiceData.vendorId && invoiceData.amount && parseFloat(invoiceData.amount) > 0
  }

  const getSelectedVendor = () => {
    return vendors.find(vendor => vendor.id === invoiceData.vendorId)
  }
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <Select 
                  ...
                  onValueChange={(value) => setInvoiceData({...invoiceData, vendorId: value})}
                >
                  <SelectTrigger>
              ...
              <div>
                ...
                <Select 
                  ...
                  onValueChange={(value) => setInvoiceData({...invoiceData, projectId: value})}
                >
                  <SelectTrigger>
