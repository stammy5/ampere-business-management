...
export default function PurchaseOrdersPage() {
  ...
  const filteredPOs = purchaseOrders.filter(po => {
    ...
    const matchesVendor = filterVendor === "all" || po.vendor.id === filterVendor
            ...
            <div className="flex items-center space-x-4">
              ...
              <Select value={filterVendor} onValueChange={setFilterVendor}>
                ...
                <SelectContent>
                  ...
                  {/* Dynamic vendor options will be populated when vendors exist */}
                </SelectContent>
              </Select>
            </div>
          </CardContent>
                    ...
                    >
                      ...
                      <TableCell>
                        <div className="flex items-center space-x-2">
                          ...
                          <div>
                            <div className="font-medium">{po.vendor.companyName}</div>
                            <div className="text-xs text-muted-foreground">{po.vendor.name}</div>
                          </div>
                        </div>
                      </TableCell>
                      <TableCell>
