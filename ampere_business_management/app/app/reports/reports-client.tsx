                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="flex items-center justify-between mt-3">
                              <Badge
                                ...
                                className={cn(
                                  "text-xs",
                                  report.status === 'ready' ? 'border-green-200 text-green-700' :
                                  report.status === 'generating' ? 'border-blue-200 text-blue-700' :
                              ...
                              <div className="flex space-x-1">
                                <DropdownMenu>
                                  ...
                                  <DropdownMenuContent>
                                    <DropdownMenuItem onClick={() => handleQuickGenerate(report.id, 'excel')}>
                                      <FileText className="w-4 h-4 mr-2" />
                                      Quick Excel
                                    </DropdownMenuItem>
                                    <DropdownMenuItem onClick={() => handleQuickGenerate(report.id, 'pdf')}>
